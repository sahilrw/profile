...
const Projects = () => {
  ...
  return (
    ...
    >
    <h2 className='text-lg md:text-2xl font-semibold md:font-bold mb-5'><span className='text-accent'>&gt;</span> FEATURED</h2>
    ...
    <h2 className='text-lg md:text-2xl font-semibold md:font-bold mt-8 mb-5'><span className='text-accent'>&gt;</span> OTHER WORK</h2>
